...
@call :makefile "%~dp0.\..\data\accesscontrol-data-GA_PROD_NETSMS_ABC.json" "consulta_dicionario/consulta@(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=5.16.8.195)(PORT=1521)))(CONNECT_DATA=(SID=abc)))"
@call :makefile "%~dp0.\..\data\accesscontrol-data-GA_PROD_NETSMS_SUL.json" "consulta_dicionario/consulta@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=5.16.8.193)(PORT=1521))(CONNECT_DATA=(SID=sul)))"
@call :makefile "%~dp0.\..\data\accesscontrol-data-GA_PROD_NETSMS_SAO.json" "consulta_dicionario/consulta@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=5.16.8.84)(PORT=1521))(CONNECT_DATA=(SID=spo)))"
@call :makefile "%~dp0.\..\data\accesscontrol-data-GA_PROD_NETSMS_BH.json" "consulta_dicionario/consulta@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=5.16.8.190)(PORT=1521))(CONNECT_DATA=(SID=bhpr)))"
@call :makefile "%~dp0.\..\data\accesscontrol-data-GA_PROD_NETSMS_CTV.json" "consulta_dicionario/consulta@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(Host=5.16.8.133)(Port=1528))(CONNECT_DATA=(SID=ctv)))"
@call :makefile "%~dp0.\..\data\accesscontrol-data-GA_PROD_NETSMS_BRA.json" "consulta_dicionario/consulta@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=5.16.8.187)(PORT=1521))(CONNECT_DATA=(SID=db09)))"
@call :makefile "%~dp0.\..\data\accesscontrol-data-GA_PROD_NETSMS_ISP.json" "consulta_dicionario/consulta@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=5.16.8.189)(PORT=1521))(CONNECT_DATA=(SID=isp)))"
@call :makefile "%~dp0.\..\data\accesscontrol-data-GA_PROD_NETSMS_SOC.json" "consulta_dicionario/consulta@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=5.16.8.191)(PORT=1521))(CONNECT_DATA=(SID=db09s)))"
@goto :sucesso
